...
Component.options.__file = "resources/assets/js/dashboard/modules/role/Create.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2038d6e0", Component.options)
  } else {
    hotAPI.reload("data-v-2038d6e0", Component.options)
  }
...
var render = function() {
  ...
  return _c(
    "vue-form",
    { attrs: { title: _vm.$t("form.create_role") } },
    [
      _c(
        "template",
        { slot: "buttons" },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2038d6e0", module.exports)
  }
}
